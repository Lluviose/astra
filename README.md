...
给成年人用的猎艳 / 约炮笔记。记下她是谁、约成几次、过夜、艳照和成就；不传开发者服务器，可随设备 iCloud Backup 恢复。iOS 原生 App，SwiftUI + MapKit，iOS 26 液态玻璃风格，Core Haptics 原生触感。
...
- **今晚焦点**：按置顶、相处阶段和已有互动选出一个值得回味或推进的人；可直接打开档案，并按当前阶段记下进展或战果，不额外猜测对方意愿
- **名册与私密排行**：每个人一张猎获档案；支持综合、欲望、床上默契、回味欲和约成次数榜单，只在本机显示
- **六维评分**：颜值、身材、床上默契、主动感、欲望值、回味欲均为 0–10，带快速预设、实时综合分、滑杆触感和旧五星数据迁移
- **记录册**：约成、过夜、照片按月成册；近 6 个月约成柱状图
- **成就册**：50 枚徽章分成猎获、约成、留宿、足迹、私藏、玩法六章，铜银金三档；「快要点亮」会优先展示最接近完成的目标。记下新猎获会翻页弹出，只给你自己看，不算排行榜
- **人物照与艳照分仓**：头像封面、普通人物资料照、艳照私藏和单次约会照片分开保存、分开浏览、分开计数
- **猎获档案**：代号 / 头像、相处状态、明确胸部尺码（下胸围 + AA–K 罩杯）、六维评分、约成 / 过夜、怎么约、她说过不行的事
