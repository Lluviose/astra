...
- **结果记录**：原生三步表单「结果 → 细节 → 跟进」，对象、结果、时间和地点确认好就能存；场所独立分类，没上床可选进展和原因；行为、高潮、防护分组填写，只复用上次行为与收尾，不自动填写这次防护、地点或花费
- **人物建档**：直接新增人物，在档案里选地点；选人时也能新增并接着记。按「基本资料 → 约法与标签 → 照片」填写，17 个认识渠道、7 组人物标签，保留自由备注和自定义标签
