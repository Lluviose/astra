...
给成年人用的猎艳 / 约炮笔记。记下她是谁、每次上床或没上床、城市足迹、艳照和成就；不传开发者服务器，可随设备 iCloud Backup 恢复。iOS 原生 App，SwiftUI + MapKit，iOS 26 液态玻璃风格，Core Haptics 原生触感。

> 想换名字？只改一处：`project.yml` 里的 `CFBundleDisplayName`（工程名、bundle id 也随之改掉即可），图标在 `Scripts/generate_icon.py`。

## 功能

- **猎场**：首页就是猎艳时间线封面。本月新人 / 上床 / 没上床 / 城市一眼能看到，记下就能回看
...
- **时间线**：记录只分「上床了 / 没上床」，按天显示具体时间、城市和备注；近 6 个月用双柱对比两种结果
- **成就册**：50 枚徽章分成猎获、上床、复盘、足迹、私藏、玩法六章，铜银金三档；「快要点亮」会优先展示最接近完成的目标。记下新猎获会翻页弹出，只给你自己看，不算排行榜
- **人物照与艳照分仓**：头像封面、普通人物资料照、艳照私藏和单次约会照片分开保存、分开浏览、分开计数
- **猎获档案**：代号 / 头像、相处状态、明确胸部尺码（下胸围 + AA–K 罩杯）、六维评分、上床 / 没上床、怎么约、她说过不行的事
- **结果记录**：对象、结果、时间和城市填了就能存；上床记录可继续补姿势、口、无套、内射、口爆、颜射、爽不爽、照片和私密备注
- **事后跟进**：回个消息、再约一次、去做检测、暴露咨询等，可设日期并勾完成
- **安全小结**：戴套、PrEP、避孕分开记，不算「安全分」，也不按人打标签
- **猎场地图**：按实际记录城市聚合，可切换全部 / 上床 / 没上三层足迹并查看城市时间线；只标记到城市级，内置 380+ 城市并处理 WGS-84 → GCJ-02 偏移
