...
- **记录册**：约成、过夜、聊骚、照片按月成册；近 6 个月约成柱状图
- **成就册**：34 枚徽章分成猎获、约成、留宿、足迹、私藏、玩法六章，铜银金三档。记下新猎获会翻页弹出，只给你自己看，不算排行榜
- **头像与艳照**：每人一张头像，每次约还能留最多 8 张照片；只复制进 App 沙盒，不进系统相册，也不进 iCloud 备份
- **猎获档案**：代号 / 头像、相处状态（刚认识 → 聊上了 → 暧昧中 → 偶尔约 / 固定约 → 先搁着 / 结束了）、约成 / 过夜 / 照片、怎么约、她说过不行的事
