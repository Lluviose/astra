...
- **星图首页**：近况总览与统一记录入口；最近人物可快捷记录，待处理事项与最近记录前置；私人图鉴、相处统计、足迹地图和成就收藏集中于浏览区，王者殿堂保留在总览卡中
...
- **王者殿堂**：从首页主卡进入，自己选择封号、王旗和王都；旧记录会自动生成传奇后宫卡、领地等级、月度 / 年度战报与五类个人纪录
- **传奇与领地升阶**：对象按 1 / 3 / 5 / 10 次升为初猎、回头、王牌、传奇；地点按 1 / 3 / 8 / 15 次升为初征、据点、主场、王城，保存记录时即时结算
- **匿名战绩卡**：本机生成生涯、年度或领地卡面，只含封号、汇总数字和抽象星点路线，不含代号、照片、地点名、日期、备注或坐标
- **记忆回访**：首页保留一个根据置顶、相处阶段与记录选择的人物档案入口，轻量呈现最近互动
...
- **照片分仓**：头像封面、普通人物照、档案照片、艳照私藏和单次约会照片分开保存、分开浏览、分开计数
- **人物档案**：头像、代号、地点与状态建立层级；数据自适应排布，一个记录入口进入结果编辑；照片、评分、线索、边界与时间线按章节呈现
- **结果记录**：对象、结果、时间、地点与保护情况先呈现，备注可直接填写；玩法、感受、照片和跟进按需展开。收起保留输入，编辑既有记录自动展开，可沿用上次的细节
...
- **原生材质**：实体内容表面支持深浅模式；iOS 26 地图悬浮控件使用 Liquid Glass，iOS 18 回退为 Material，降低透明度时改用实体表面
