...
export default function Record() {
  ...
  const draft = { person, newName, kind, title, date, city, note, protection, followUp };
  ...
  return <FormScreen title="相处记录" saveLabel="保存片刻" error={error} busy={busy} dirty={JSON.stringify(draft) !== initialDraft} onSave={() => void save()}>
      <View style={{ maxWidth: 640, width: "100%", alignSelf: "center" }}>
        ...
        <FormSection number="02" title="这次相处">
          ...
          <View style={{ flexDirection: "row", gap: 13 }}><View style={{ flex: 1 }}><Field label="日期" value={date} onChangeText={setDate} placeholder="YYYY-MM-DD" keyboardType="numbers-and-punctuation" /></View><View style={{ flex: 1 }}><Field label="城市（可选）" value={city} onChangeText={setCity} placeholder="相处的城市" /></View></View>
